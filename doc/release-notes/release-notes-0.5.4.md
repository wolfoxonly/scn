StarChain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/StarChain/files/StarChain/StarChain-0.5.4/
...
http://gitorious.org/StarChain/StarChaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix StarChain-Qt notifications under Growl 1.3.
Increase required age of StarChain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxStarChain properly when installing StarChain-Qt over it. (Windows)
