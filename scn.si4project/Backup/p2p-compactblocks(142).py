...
# TestNode: A peer we use to send messages to StarChaind, and store responses.
...
class CompactBlocksTest(StarChainTestFramework):
    ...
    # This test actually causes StarChaind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that StarChaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for StarChaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # StarChaind will not send blocktxn responses for blocks whose height is
