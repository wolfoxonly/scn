...
const QString BITCOIN_IPC_PREFIX("Starchain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Starchain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Starchain: click-to-pay handler");
    else
...
{
    // clicking on Starchain: URLs creates FileOpen events on the Mac:
