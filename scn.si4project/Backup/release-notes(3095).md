...
StarChain Core version *version* is now available from:

  <https://StarChain.org/bin/StarChain-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile StarChain Core is now 4.8. No effort will be
