Starchain Core version 0.10.4 is now available from:

  <https://Starchain.org/bin/Starchain-core-0.10.4/>
...
- #6953 `43c2789` Split Starchain-tx into its own package
- #6953 `dfe0d4d` Include Starchain-tx binary on Debian/Ubuntu
