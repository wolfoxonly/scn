Starchain Core version 0.13.2 is now available from:

  <https://Starchain.org/bin/Starchain-core-0.13.2/>
...
- #8908 `4a974b2` Update Starchain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Starchain-tx to create v2 transactions (btcdrak)
