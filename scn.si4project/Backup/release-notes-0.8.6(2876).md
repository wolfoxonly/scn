Starchain-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/Starchain/files/Starchain/Starchain-0.8.6/
...
- Fix Starchain-Qt startup crash when clicking dock icon on OSX 
...
Note: Gavin Andresen's GPG signing key for SHA256SUMS.asc has been changed from  key id 1FC730C1 to sub key 7BF6E212 (see https://github.com/Starchain/Starchain.org/pull/279).
