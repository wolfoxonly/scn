...
This document provides guidelines for internationalization of the Starchain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Starchain_en.ts` remains unchanged.
