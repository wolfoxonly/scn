...
bool IsCanonicalSignature(const valtype &vchSig) {
    // See https://Starchaintalk.org/index.php?topic=8392.msg127623#msg127623
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // Starchain address tx, sender provides hash of pubkey, receiver provides signature and pubkey
