...
class BIP66Test(StarChainTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # StarChaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and StarChaind produces more specific reject
            # reasons.
